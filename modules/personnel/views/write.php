...
class View extends \Gcms\View
{
    ...
    public function render($index)
    {
        ...
        $groups->add('select', array(
            ...
            'itemClass' => 'width50',
            'options' => array(0 => '{LNG_Please select}') + $category->department(),
        ...
        $groups->add('select', array(
            ...
            'label' => '{LNG_Position}',
            'itemClass' => 'width50',
            'options' => array(0 => '{LNG_Please select}') + $category->position(),
        ...
        $fieldset->add('file', array(
            ...
            'itemClass' => 'item',
            'label' => '{LNG_Image}',
            'comment' => '{LNG_Browse image uploaded, type :type size :width*:height pixel} ({LNG_resized automatically})',
