...
class View extends \Gcms\View
{
        ...
        $table = new DataTable(array(
            ...
            'filters' => array(
                'department' => array(
                    ...
                    'default' => 0,
                    'text' => '{LNG_Department}',
                    'options' => array(0 => '{LNG_all items}') + $this->category->department(),
                ...
                'position' => array(
                    ...
                    'default' => 0,
                    'text' => '{LNG_Position}',
                    'options' => array(0 => '{LNG_all items}') + $this->category->position(),
    ...
    {
        if ($btn == 'edit') {
            return $this->login === true || $this->login['id'] == $items['id'] ? $attributes : false;
        } else {
            return $attributes;
        }
    }
